...
const CreateContainer = () => {
  ...
  const [alertStatus, setAlertState] = useState("danger");
  ...
  const uploadImage = (e) => {
    ...
    uploadTask.on(
      ...
      (error) => {
        console.log(error);
        setFields(true);
        setMsg("Error while uploading : Tye Again", error);
              ...
              {!imageAsset ? (
                ...
                <>
                  <div className="relative h-full ">
                    ...
                    <button
                      type="button"
                      className="absolute bottom-3 right-3 p-3 rounded-full bg-red-500 text-xl outline-none hover:shadow-md duration-500 transition-all ease-in-out"
                      onClick={deleteImage}
                    >
